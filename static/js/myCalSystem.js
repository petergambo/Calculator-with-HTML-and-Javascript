...
// Function to display clicked button value to the screen
    function add(clickedBtn)
    {
        ...
        if (parseInt(screen.value) == 0 && powerBTN.innerHTML == "OFF") // Identifies if its first value to be added. When calculator powers on, default screen value is 0
        {
            ...
            document.getElementById('instructions').innerHTML="<img src='../static/images/peebot.jpg' height='20' width='20' style='border-radius: 50%;'> <span style='color: #ffc83d; font-weight: bold;'>PEE BOT: </span>Perfect!<br>Keep Going! &#128077;"
        }
        else if(parseInt(screen.value) > 0 && powerBTN.innerHTML == "OFF") //This means that there is an existing value on our screen and this is not the users first action
        {
            ...
            document.getElementById('instructions').innerHTML="<img src='../static/images/peebot.jpg' height='20' width='20' style='border-radius: 50%;'> <span style='color: #ffc83d; font-weight: bold;'>PEE BOT: </span>Good!<br>You're doing well! &#128077;"
        }
        else{
            document.getElementById('instructions').innerHTML="<img src='../static/images/peebot.jpg' height='20' width='20' style='border-radius: 50%;'> <span style='color: #ffc83d; font-weight: bold;'>PEE BOT: </span>Oops, I am OFF!<br>Switch me ON first"
    ...
    function del()
    {
        ...
        document.getElementById('instructions').innerHTML="<img src='../static/images/peebot.jpg' height='20' width='20' style='border-radius: 50%;'> <span style='color: #ffc83d; font-weight: bold;'>PEE BOT: </span><br>Alright"
        }
    ...
    function clearScreen() 
    {
        ...
        {
            screen.value = "0";
            document.getElementById('instructions').innerHTML="<img src='../static/images/peebot.jpg' height='20' width='20' style='border-radius: 50%;'> <span style='color: #ffc83d; font-weight: bold;'>PEE BOT: </span> Cleared! <br>Ride On!"
    ...
    function compute() 
    {
        ...
        if (countLength > 0) 
        {
            ...
            document.getElementById('instructions').innerHTML="<img src='../static/images/peebot.jpg' height='20' width='20' style='border-radius: 50%;'> <span style='color: #ffc83d; font-weight: bold;'>PEE BOT: </span><br>Done!" //&#128079;
        }
